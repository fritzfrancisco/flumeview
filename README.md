...
Image 1.: Choice flume with channel (2 -3) and area (3-4) positions (A & B) and arrows showing the current orientation (Gerlach et al. 10.1073/pnas.0606777104.)

The flume is set up in four compartments between which the fish can freely move and chose
